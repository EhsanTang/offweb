...
<body class="small-width">
	...
	<div class="container mb30" ng-app="app" class="p10" ng-controller="admController">
			<div class="news-detail row shadow bg-white mt10 p50 lh26 min-h400" ng-if="list.Model.type=='INFOR'">
				<div class="tc">
		...
		<div class="news-detail row shadow bg-white mt0 p0 min-h400 p20 lh26" ng-if="list.Model.type!='INFOR'">
