...
<link href="def/global.css" rel="stylesheet" type="text/css" />
<link href="def/pageCss.css" rel="stylesheet" type="text/css" />
<style type="text/css">
...
<!--[if lt IE 9]>
 ...
 <![endif]-->
<title>
	<s:property value="@cn.wegoteam.shop.cache.StaticDataCache@getStaticdata('WEB_NAME').lang"/>-${pageTitle}</title>
</head>