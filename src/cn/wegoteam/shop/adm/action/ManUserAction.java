...
public class ManUserAction extends BaseAction<User> {
	...
	@Action(value = "manageUserList", results = { @Result(name = "success", location = MANAGE
			+ "list.jsp") })
	...
	public void manageLoadUser() {
		...
		writeStringToResponse(userService
				.getJsonList(pageBean,
	...
	// 添加或者修改一个用户对象
	@Action(value = "manageFindUserById", results = { @Result(name = SUCCESS, location = MANAGE
			+ "addUser.jsp") })
