		...
		<tr>
			<td>
			    <div class="input-group">
	     			 ...
	     			 <input name="cntitle" value="${model.cntitle}" type="text" class="form-control"/>
	    		</div>
			</td>
			<td>
				<div class="input-group">
		...
		<tr>
			<td colspan="2">
				<div class="input-group w">
	     			 ...
	     			 <input id="type" class="form-control" name="type"
			...
			<td colspan="2">
				<div class="input-group w">
	      			 ...
	      			 <div class="form-control">
		     			 <input type="radio" name="canComment" <s:if test="model.canComment">checked</s:if> value="true">&nbsp;&nbsp;
							是
						 <input type="radio" name="canComment" <s:if test="!model.canComment">checked</s:if> value="false">&nbsp;&nbsp;
							否
					 </div>
	    		</div>
	    	</td>
		...
		<tr>
			<td colspan="2">
				<div class="input-group w">
	     			...
	     			<input name="tag" type="text" class="form-control" value="${model.tag}" />
				</div>
	    	</td>
		</tr>
		<tr>
			<td>
				中文简介:
				<textarea name="cnbrief" class="form-control" id="cnbrief"
					rows="3">${model.cnbrief}</textarea>
			</td>
			<td>
				英文简介:
				<textarea name="enbrief" class="form-control" id="enbrief"
					rows="3">${model.enbrief}</textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<div class="input-group w">
	      			 ...
	      			 <input class="form-control" name="click" type="text" value="${model.click}" readonly/>
				</div>
	    	</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<div class="input-group w">
	      			 ...
	      			 <input class="form-control" name="date" value="${model.date}" type="text"  id="datetimepicker"/>
				</div>
	    	</td>
		</tr>
	</table>
