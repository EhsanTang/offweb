...
CREATE TABLE `news` (
  ...
  `url` varchar(200) DEFAULT NULL COMMENT '图片、视屏地址',
  `type` varchar(15) NOT NULL DEFAULT 'INFOR' COMMENT '新闻类型：通知（INFOR）',
  ...
  `addTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `enbrief` varchar(500) DEFAULT NULL COMMENT '英语简介',
  `cnbrief` varchar(200) DEFAULT NULL COMMENT '中文简介',
  `style` varchar(15) NOT NULL DEFAULT 'detail',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `tag_UNIQUE` (`tag`),
  KEY `FK_type_idx` (`type`),
  CONSTRAINT `FK_type` FOREIGN KEY (`type`) REFERENCES `staticdata` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `setting` (`id`,`skey`,`value`,`remark`,`flag`,`addTime`,`verify`) VALUES 
 ...
 (13,'SECOND_COLOR','#000000;','<div style=\"color:#000000\">网站次要颜色(顶部背景色)</div>',0,'2015-08-17 11:55:38',''),
 (14,'PRIMARY_COLOR','#3A3838;','<div style=\"color:#3A3838\">网站主色(顶部菜单背景色）</div>',0,'2015-08-17 11:55:38',''),
 ...
 (20,'MATCH_COLOR','#e35b21','<div style=\"color:#e35b21\">网站配色</div>',0,'2015-08-17 11:55:38',''),
 (21,'WEB_NAME','E通世界','',-100,'2015-08-17 11:55:38',NULL),
 (22,'LINK_COLOR','#FFFFFF','<div style=\"color:#FFFFFF\">超链颜色</div>',0,'2015-08-17 11:55:38',''),
 (23,'HOVER_COLOR','#B20000','<div style=\"color:#B20000\">a:hover 颜色</div>',0,'2015-08-17 11:55:38',''),
 (24,'KF_PHONE','010-85654599','客服电话',1,'2015-08-17 11:55:38',NULL),
 (25,'KF_EMAIL','kf@ytworld.cn','客服邮箱',1,'2015-08-17 11:55:38',NULL),
 (26,'SUBJECT','tradition','主题',1,'2015-08-19 10:00:17',''),
 (27,'WEBURL','http://yitongworld.com','网站地址',1,'2015-08-19 12:09:39',NULL),
 (28,'IOS_IMG','images/ios.jpg','IOS二维码',1,'2015-08-19 14:45:23',''),
 (29,'ANDROID_IMG','images/android.jpg','安卓二维码',1,'2015-08-19 14:46:08',''),
 (30,'ANDROID_LINK','http://zhushou.360.cn/detail/index/soft_id/3040905','安卓下载地址',1,'2015-08-19 14:50:13',''),
 (31,'IOS_LINK','http://www.pgyer.com/uxyv','IOS下载地址',1,'2015-08-19 15:35:22','');
...
INSERT INTO `staticdata` (`id`,`code`,`pcode`,`value`,`name`,`description`,`link`,`flag`,`order_list`,`type`,`enName`,`addTime`) VALUES 
 ...
 (2,'SUBMENU1','MENU','','联系我们','			','go?p=detail&p_tag=CONTACT',1,4,'MENU','Contact Us','2015-08-17 11:56:24'),
 (3,'SUBMEUN2','MENU','','新闻','                \r\n				','go?p=list',1,12,'MENU','Information','2015-08-17 11:56:24'),
 (4,'SUBMENU3','MENU','','关于我们','                \r\n				','go?p=detail&p_tag=ABOUTUS',1,6,'MENU','About Us','2015-08-17 11:56:24'),
 (5,'SUBMENU4','MENU','','产品','','go?p=detailPage&p_tag=PRODUCT',1,16,'MENU','Products','2015-08-17 11:56:24'),
 (24,'INDEXSLIDE','TOP','','首页滚动图片 ','','',1,2,'NO','','2015-08-17 11:56:24'),
 (25,'INDEX_IMG1','INDEXSLIDE','attached/images/20150817/95070_叮叮通.jpg','NO','叮叮通','go?p=detail&p_tag=PRODUCT1',1,2,'SLIDE','','2015-08-17 11:56:24'),
 (26,'INDEX_IMG2','INDEXSLIDE','attached/images/20150817/83003_banner2.jpg','NO','私人秘书','go?p=detail&p_tag=PRODUCT3',1,1,'SLIDE','','2015-08-17 11:56:24'),
 (27,'INDEX_IMG3','INDEXSLIDE','attached/images/20150817/25914_banner.jpg','NO','智能生活馆','go?p=detail&p_tag=PRODUCT2',1,4,'SLIDE','','2015-08-17 11:56:24'),
 ...
 (34,'ENGLISH','L_LANGUAGE','','English','<i class=\"iconfont\"></i> 		','http://en.yitongworld.com/index',1,9,'NO','English','2015-08-17 11:56:24'),
 (65,'TOP','TOP','','顶级父类','根据类型查找时不会在根据PCOD查找。该列无实际用处，仅仅作为其他数据的PCODE','',1,0,'NO',NULL,'2015-08-17 11:56:24'),
 (78,'CHINESE','L_LANGUAGE','','中文','<i class=\"iconfont\"></i> ','http://yitongworld.com/index',1,0,'NO','中文','2015-08-17 11:56:24'),
 ...
 (150,'L_FRIENDLY','LABEL','','友情链接：','','',1,0,'NO','FRIENDLY:','2015-08-17 11:56:24'),
 ...
 (156,'SHANGJIARUZHU','MENU','','商家入驻','','go?p=detail&p_tag=SJRZ',1,10,'MENU','Tenants ','2015-08-17 11:56:24'),
 (157,'DOWNLOAD','TOPBAR_R','','应用下载','<i class=\"iconfont\"></i> ','go?p=detail&p_tag=DOWLOAD',1,0,'NO','App Download','2015-08-17 11:56:24'),
 ...
 (160,'SUBJECT','TOP','','主题','','',1,1,'NO','','2015-08-19 09:59:20'),
 (161,'def','SUBJECT','','默认主题','','',1,1,'NO','','2015-08-19 10:00:02'),
 (162,'SETTING_MENU','ADMIN_SETTING','href=\"adminJsp?jspName=staticdataList&p_code=MENU\"','主菜单','','',1,3,'NO','','2015-08-19 14:30:37'),
 (163,'L_LANGUAGE','LABEL','','语言','','',1,1,'NO','Language','2015-08-19 14:35:42'),
 (164,'L_ANDROID','LABEL','','安卓下载','','',1,1,'NO','Android Download','2015-08-19 14:43:06'),
 (165,'L_IOS','LABEL','','IOS下载','','',1,2,'NO','IOS Download','2015-08-19 14:44:19'),
 (166,'NEWSTYPE','TOP','','新闻类型','','',1,1,'NO','','2015-08-20 11:08:11'),
 (167,'INFOR','NEWSTYPE','','新闻资讯','','',1,1,'NO','','2015-08-20 11:09:22'),
 (168,'PAGE','NEWSTYPE','','网站页面','','',1,2,'NO','','2015-08-20 11:10:10'),
 (169,'tradition','SUBJECT',',detailPage,detailImg,detail,','传统主题','值表示该主题包含的页面','',1,2,'NO','','2015-08-20 12:05:10'),
 (170,'L_BRIEF','LABEL','','what can we do?','公司简介','',1,1,'NO','what can we do?','2015-08-20 14:49:17'),
 (171,'BRIEF_CONT','L_BRIEF','','北京亿通世界网络科技有限公司（简称：\"亿通世界\"），是一家专业的移动<br>互联网O2O整体解决方案提供商。<a href=\"go?p=detail&p_tag=ABOUTUS\"  style=\"color:blue\">(详情)</a>','公司简介','',1,1,'NO','Beijing hundred million tong world network technology co., LTD, is a professional mobile Internet<br> O2O overall solution provider.<a href=\"go?p=detail&p_tag=ABOUTUS\"  style=\"color:blue\">(Detail)</a>','2015-08-20 14:52:53'),
 (172,'PRODUCT','NEWSTYPE','','产品','','',1,2,'NO','','2015-08-20 15:30:17'),
 (173,'NEWS_PROD','ADMIN_NEWS','href=\"adminJsp?jspName=newsList&p_type=PRODUCT\"	','产品','','href=\"adminJsp?jspName=newsList&p_type=PRODUCT\"	',1,3,'NO','','2015-08-20 15:31:25'),
 (174,'NEWSSTYLE','TOP','','详情展示样式','','',-100,2,'NO','','2015-08-21 10:25:10'),
 (175,'TRA_DEF','tradition','detail','默认样式','','',1,1,'DETAIL','','2015-08-21 10:26:30'),
 (176,'DEF_DEF','def','detail','默认样式','','',1,2,'DETAIL','','2015-08-21 10:30:37'),
 (177,'TRA_IMG','tradition','detailImg','图片展示类型','','',1,2,'DETAIL','','2015-08-21 10:46:04'),
 (178,'TRA_PAGE','tradition','detailPage','普通页面','','',1,3,'DETAIL','','2015-08-21 10:47:05');
...
INSERT INTO `user` (`id`,`name`,`sex`,`email`,`phone`,`password`,`qq`,`bounds`,`grade`,`insertTime`,`flag`,`type`,`authority`,`role`,`addTime`) VALUES 
 ...
 (91,'111','MALE','','','b59c67bf196a4758191e42f76670ceba','',0,1,'2015-08-18 17:28:23',-100,'AVERUSER','','','2015-08-18 17:28:23');
